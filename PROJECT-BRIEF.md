...
- **Residential moving and temporary storage**
- **Home decluttering and seasonal storage**
- **Construction and contractor job sites** (tools, parts, weather-resistant staging)
- **Events** (supplies, back-of-house storage)
- **Equipment protection** during renovations or transport

Beyond the core containers, we offer **related accessories**: cleaning supplies, padding, locks, and other add-ons that make packing and securing contents easier.

Fulfillment is built around **delivery and pickup**: we bring empty bins when and where the customer needs them, and retrieve them after use (with optional scheduling for high-volume or commercial accounts).

## Target audience

| Segment | Needs | Messaging emphasis |
|---------|--------|----------------------|
| **Homeowners & renters** | Moving, remodeling, garage/basement organization | Simplicity, clear pricing, “we deliver / we pick up” |
| **DIY movers** | Affordable alternative to buying boxes; stackable, reusable | Cost vs. cardboard, durability, environmental angle (reuse) |
| **Contractors & builders** | Rugged bins on site; quick turnaround | Job-site toughness, stackability, rental terms |
| **Small businesses & offices** | Short-term storage, events, inventory bursts | Professional appearance, invoicing, recurring rental |
| **Event planners / venues** | Temporary storage for supplies | Logistics, timed delivery/pickup |
...
- Qualified quote requests and completed online bookings
- Mobile bounce rate and time-on-page for product and pricing pages
- Conversion from pricing page to checkout or contact
- Post-launch: customer support tickets related to “how to book” or “what’s included” (target: downward over time)

## Out of scope (v1 unless noted)

- Full custom CRM replacement
- Multi-warehouse optimization (can be a later phase)
