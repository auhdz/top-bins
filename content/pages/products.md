...
### Large bin / deep crate

- **Best for:** Bulky items, tools, event supplies, heavier loads within safe limits.
- **Approx. dimensions:** [L × W × H]
- **Capacity:** [volume]
- **Features:** Reinforced corners, high stack stability
- **From:** $[X] / week + delivery

### Contractor / job-site bundle

- **Best for:** Sites that need multiple units on a schedule.
- **Includes:** [N] large crates + optional add-ons
- **From:** Custom quote for recurring or high volume

---

## Comparison table (optional)

| | Standard | Large | Notes |
|--|----------|-------|--------|
| Stackable | Yes | Yes | Max stack guidance in FAQ |
| Lid | Yellow secure lid | … | |
| Weight limit | … | … | |
...
**Primary:** Start your rental  
**Secondary:** Get a quote for 20+ units

---

## SEO

- **Title:** Rent Storage Bins & Crates | Sizes & Pricing [Brand]
- **Meta:** Compare bin sizes, features, and rental rates. Heavy-duty plastic containers with delivery and pickup.
